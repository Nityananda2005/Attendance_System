                  ...
                  <div className="bg-[#f8fafc] border border-gray-100 dark:border-slate-700 rounded-[40px] p-8 sm:p-14 flex flex-col items-center justify-center text-center h-full min-h-[600px] xl:min-h-0 xl:h-[calc(100%-80px)] transition-all">
                    ...
                    {sessionCode ? (
                      <>
                        ...
                        <h3 className="text-[20px] font-extrabold text-gray-900 dark:text-white mb-2 tracking-tight">Scan to mark presence</h3>
                        <p className="text-[14px] font-semibold text-gray-500 dark:text-slate-400 mb-8">Enter code <span className="font-black text-gray-800 dark:text-slate-200 tracking-widest">{sessionCode}</span> or scan below</p>
                      ...
                      <>
                        ...
                        <h3 className="text-[20px] font-extrabold text-gray-600 dark:text-slate-400 mb-2 tracking-tight">Dynamic Attendance QR</h3>
                        <p className="text-[14px] font-semibold text-gray-400 dark:text-slate-500 mb-10">Generate a session to display QR</p>
                        ...
                        <div className="w-full max-w-[280px] aspect-square bg-white dark:bg-slate-800 rounded-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-slate-700 flex items-center justify-center relative overflow-hidden">
                           ...
                           <div className="absolute inset-0 m-auto w-[25%] h-[25%] bg-[#f8fafc]/80 rounded-full flex items-center justify-center backdrop-blur-sm z-10 border border-gray-100 dark:border-slate-700">
                             <QrCode className="w-8 h-8 text-gray-300 dark:text-slate-600" strokeWidth={1.5} />
                           </div>
                           <QrCode className="absolute inset-0 m-auto w-[50%] h-[50%] text-gray-200 dark:text-slate-700/40" strokeWidth={0.5} />
                        </div>
                      </>
                    )}
