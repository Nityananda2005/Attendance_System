...
import { 
  BookOpen, ChevronRight, Info, Users, Calendar, Clock, CheckCircle2, Loader2, PlusCircle
} from 'lucide-react';
  ...
  const handleGenerate = async () => {
    ...
    const submitSession = async () => {
      ...
      try {
        ...
        const code = res.data.sessionCode || res.data.session?.sessionCode;
        setSessionCode(code);
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
            ...
            <div className="flex flex-col xl:flex-row gap-8">
               ...
               <div className="flex-1 space-y-6">
                 ...
                 {/* Form Card */}
                 <div className="glass-panel rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-700">
                 ...
                 <div className="glass-card-3d !bg-blue-50/50 dark:!bg-blue-500/5 border-blue-100 dark:border-blue-500/20 p-7 flex items-start gap-4">
                   <div className="w-10 h-10 rounded-full bg-blue-100/80 dark:bg-blue-500/20 flex items-center justify-center shrink-0 mt-0.5 shadow-inner">
                     <Info className="w-5 h-5 text-blue-500 dark:text-blue-400" strokeWidth={2.5}/>
                   </div>
                   <div>
                     <h4 className="text-[14px] font-black text-[#1e3a8a] dark:text-blue-400 mb-1.5 tracking-tight">Security Protocol Paused</h4>
                     <p className="text-[13px] font-semibold text-[#1e3a8a]/70 dark:text-slate-400 leading-relaxed pr-4">Geolocation restrictions are currently bypassed. Students can mark attendance regardless of their physical proximity to your location.</p>
                   </div>
                 </div>

                 {/* Stats Cards */}
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div className="glass-card-3d p-6 flex items-center justify-center gap-4">
                      <div className="w-11 h-11 rounded-full bg-[#f8fafc] dark:bg-slate-800 border border-gray-100 dark:border-slate-700 flex items-center justify-center shrink-0">
               ...
               {/* Right Column - QR display area */}
                <div className="w-full xl:w-[420px] shrink-0">
                   <div className="glass-panel rounded-[40px] p-8 sm:p-14 flex flex-col items-center justify-center text-center h-full min-h-[600px] xl:min-h-0 xl:h-[calc(100%-80px)] transition-all hover:shadow-[0_40px_80px_rgba(59,130,246,0.2)]">
